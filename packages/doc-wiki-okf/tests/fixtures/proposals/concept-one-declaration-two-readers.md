...
- ref: sources/2026-08-design-spec-okf-ext-sections-capability
  ...
  - 'The pattern is the stated substrate for the next capability: work/2026-08-06-feature-okf-ext-generators-capability adds an ownership field to SectionSpec, which is additive precisely because there is one declaration for it to be additive to.'
