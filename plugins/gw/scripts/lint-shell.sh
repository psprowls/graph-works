#!/usr/bin/env bash
#
# Adopted verbatim from `git show 032a9912:plugins/graph-works/scripts/lint-shell.sh`
# (the vendored subtree's own copy, at the last commit before it was deleted)
# as a one-time adoption for the native plugin root, which had no such
# script of its own.
#
