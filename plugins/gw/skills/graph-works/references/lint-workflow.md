...
Grep for concept-shaped phrases repeated across 3+ package/explanation pages but without a dedicated explanation page. Suggest creating one. Comparisons (`<a>-vs-<b>.md`) live under `docs/explanations/`.
