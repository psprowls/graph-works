...
_READER_DELEGATIONS = [
    ...
    ("external_dependencies_of", queries, "external_dependencies_of", (), {"uri": "pkg:o/r/n"}),
    ("internal_dependencies_of", queries, "internal_dependencies_of", (), {"name": "n"}),
    ("internal_dependency_uris_of", queries, "internal_dependency_uris_of", (), {"uri": "pkg:o/r/n"}),
