...
# rather than an extension of tests/hooks/test-session-start.sh: that suite is
# verbatim upstream (plugins/PATCHES.md entry #21) and coverage for a fork-only
# hook does not belong in a file we are keeping conflict-free.
#
